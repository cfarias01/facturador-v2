...
|--------------------------------------------------------------------------
|
| Antes vivian en routes/api.php, dentro de la rama
...
| middleware, no hace falta Route::domain() ni la resolucion eager de Hyn.
|
*/
...
Route::prefix('api')
    ...
    ->group(function () {
        ...
        Route::post('create/invoice', 'Tenant\DocumentApiController@createInvoice');
        Route::post('create/note', 'Tenant\DocumentApiController@createNote');
        Route::post('create/noteDebit', 'Tenant\DocumentApiController@createNoteDebit');
        Route::post('create/liquidation', 'Tenant\DocumentApiController@createLiquidation');
        Route::post('create/guide', 'Tenant\DocumentApiController@createGuide');
        Route::post('create/retention', 'Tenant\DocumentApiController@createRetention');
        Route::post('recreate/invoice', 'Tenant\DocumentApiController@reCreateInvoice');
        Route::post('recreate/note', 'Tenant\DocumentApiController@reCreateNote');
        Route::post('recreate/retention', 'Tenant\DocumentApiController@reCreateRetention');


        Route::get('status/document', 'Tenant\DocumentApiController@getStatusDocument');
        Route::get('delete/document', 'Tenant\DocumentApiController@deleteDocument');
    });
