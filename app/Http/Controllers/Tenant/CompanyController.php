...
class CompanyController extends Controller
{
    ...
    public function store(CompanyRequest $request)
    {
        ...
        $configuration->smtp_host = $request->input('smtp_host');
        $configuration->smtp_port = $request->input('smtp_port');
        $configuration->smtp_user = $request->input('smtp_user');
        $configuration->smtp_password = $request->input('smtp_password');
        $configuration->smtp_encryption = $request->input('smtp_encryption');
        $configuration->save();
