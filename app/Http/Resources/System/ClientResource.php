    ...
    class ClientResource extends JsonResource
    {
        ...
        public function toArray($request)
        {
            ...
            return [
                ...
                'ftpEmitidosServer' =>  $this->ftpEmitidosServer,
                'ftpEmitidosPort' =>  $this->ftpEmitidosPort,
                'ftpEmitidosUser' =>  $this->ftpEmitidosUser,
                'ftpEmitidosPass' =>  $this->ftpEmitidosPass,
                'ftpEmitidosRutaFac' =>  $this->ftpEmitidosRutaFac,
                'ftpEmitidosRutaNota' =>  $this->ftpEmitidosRutaNota,
                'ftpEmitidosRutaRetencion' =>  $this->ftpEmitidosRutaRetencion,
