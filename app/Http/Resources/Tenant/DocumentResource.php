...
class DocumentResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        */
        ...
        $data = [
            'id' => $document->id,
            'external_id' => $document->claveAcceso,
            //'group_id' => $document->group_id,
            'number' => $document->secuencial,
            //'regularize_shipping' => (bool) $document->regularize_shipping,
            'date_of_issue' => $document->fecha,
            'customer_email' => $document->correo,
            //'download_pdf' => $document->download_external_pdf,
            'print_ticket' => url('')."/print/cabeceraDocumentoElectronica/{$document->claveAcceso}/ticket",
            'print_ticket_58' => url('')."/print/cabeceraDocumentoElectronica/{$document->claveAcceso}/ticket_58",
            'print_ticket_50' => url('')."/print/cabeceraDocumentoElectronica/{$document->claveAcceso}/ticket_50",
            'print_a4' => url('')."/print/cabeceraDocumentoElectronica/{$document->claveAcceso}/a4",
            'print_a5' => url('')."/print/cabeceraDocumentoElectronica/{$document->claveAcceso}/a5",
            ...
            'customer_telephone' => $document->telefono,
            'message_text' => "Su comprobante de pago electrónico {$this->secuencial} ha sido generado correctamente, puede revisarlo en el siguiente enlace: ".url('')."/print/cabeceraDocumentoElectronica/{$this->claveAcceso}/a4"."",
            //'sales_note' => $nvs,
