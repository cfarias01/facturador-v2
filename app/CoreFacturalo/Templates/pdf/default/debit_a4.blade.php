                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 10px 15px 10px 15px; text-align: center;">
                                    <pre style="tab-size: 16; font-size: 14px"><strong>NOTA DE DÉBITO     </strong>     No.{{$document_number}}</pre>
                                </td>
                            </tr>
                            <tr>
            ...
            <tbody>
                <tr>
                    <td style="text-transform: uppercase;" width="50%">
                        <div>
                            <strong>Razón Social: </strong>{{ $document->cliente }}<br></br>
                    ...
                    <td style="text-transform: uppercase;" width="50%">
                        <div>
                            <br></br>
                            <strong>{{ $returnPurchases->supplier_identity_document_type_description }}: </strong> {{ $returnPurchases->supplier_number }}<br></br><br></br>
    ...
    <div>
        <table class="full-width mt-10 mb-10">
            ...
            <tr style="background: #eaeaea;">
                <th class="text-center">RAZÓN DE LA MODIFICACIÓN</th>
                <th class="text-center">VALOR DE LA MODIFICACIÓN</th>
            </tr>
            </thead>
            <tbody>
            @foreach($returnPurchases->items as $row)
                <tr style="background: #f7f7f5;">
                    <td class="text-left align-top" style="padding-left: 10px">
                        {!!$row['description']!!}
                    </td>
                    <td class="text-right align-top" style="padding-right: 10px">{{ number_format($row['total'], 2) }}</td>
                </tr>
                <tr style="background: #f7f7f5;">
                    <td colspan="2"></td>
                </tr>
                ...
                <td width="40%">
                    ...
                    @if ($returnPurchases->currency_type_id === 'USD')
                        <tr>
                            ...
                            <td class="text-right" style="padding-left: 15px; padding-right: 15px; background: #eaeaea;">${{ number_format($document->baseIva0, 2) }}</td>
                        </tr>
                        <tr>
                            <td style="padding-left: 15px; padding-right: 15px; background: #f7f7f5;">Subtotal 12%:</td>
                            <td class="text-right" style="padding-left: 15px; padding-right: 15px; background: #eaeaea;">${{ number_format($document->baseIva12, 2) }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right" style="padding-left: 15px; padding-right: 15px; background: #eaeaea;">${{ number_format($document->valorIva12, 2) }}</td>
                        </tr>
                        <tr>
