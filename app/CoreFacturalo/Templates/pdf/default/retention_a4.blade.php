@php
    ...
    if ($document->adicionales != null) {
        ...
        $fixStr = trim($document->adicionales);
    ...
    <div>
        <table class="full-width mt-10 mb-10">
            ...
            <tr style="background: #eaeaea;">
                <th class="text-left py-2 pl-4" width="12%">COMPROBANTE</th>
                <th class="text-center py-2" width="12%">NÚMERO</th>
            ...
            <tbody>
            @foreach($returnPurchases->itemsRet as $row)
                <tr style="background: #f7f7f5;">
                    <td class="text-left align-top pl-4">
                        {!!$row['document_type_afect']!!}
                    </td>
                    <td class="text-center align-top">
                        {!!$row['serieDocAfectado']!!}
                    </td>
                    <td class="text-center align-top">
                        {!!$row['fechaDocAfectado']!!}
                    </td>
                    <td class="text-center align-top">
                        {!!$row['exercise']!!}
                    </td>
