        ...
        <div class="row ">
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 ">
                ...
                <div class="row mt-2" v-if="see_more">
                    ...
                    <div class="col-lg-2 col-md-2">
                        <div class="form-group"  >
                            <label class="control-label">Documento/Id Interno</label>
                            <el-input placeholder="Ingresar"
                                v-model="search.nameDocument">
                            </el-input>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 ">
                        <div class="form-group">
                            <label class="control-label">RUC/CI Cliente</label>
                            <el-input placeholder="Ingresar"
                    ...
                    <div class="col-lg-6 col-md-6 col-md-6 col-sm-12" style="margin-top:29px">
                        ...
                        <el-button v-if="records.length > 0 " class="submit" type="success" @click.prevent="clickDownload('excel')" icon = "fa fa-file-excel"> Exportal Excel </el-button>
                    </div>
...
export default {
        ...
        methods: {
            ...
            clickDownload(type) {
                ...
                let DocumentTipyId = this.search.document_type_id;
                //delete(query.user_id)
                //delete(query.document_type_id)
                console.log('DATA: ',this.search );
                console.log(`/documents/payments-complete/?${query}&user_id=1&document_type_id=1`);
                window.open(`/documents/payments-complete/?${query}&user_id=1&document_type_id=${DocumentTipyId}`, '_blank');
            },
