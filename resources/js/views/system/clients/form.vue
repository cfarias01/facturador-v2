        ...
        <form
            ...
            <div class="form-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div :class="{'has-danger': errors.emailLogo}"
                             class="form-group">
                            <label class="control-label">URL Logo Imagen</label>
                            <el-input
                                v-model="form.emailLogo"
                                dusk="emailLogo">
                            </el-input>
                            <small
                                v-if="errors.emailLogo"
                                class="form-control-feedback"
                                v-text="errors.emailLogo[0]">
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 center-el-checkbox mt-4" hidden>
                    ...
                    <div class="col-md-6 center-el-checkbox mt-4">
                        <div :class="{'has-danger': errors.ftpDocEmitidos}"
                             class="form-group">
                            <el-checkbox
                                v-model="form.ftpDocEmitidos">
                                Conectar a FTP(Documentos Emitidos)
                            </el-checkbox>
                            <br>
                            <small
                                v-if="errors.ftpDocEmitidos"
                                class="form-control-feedback"
                                v-text="errors.agente_retencion[0]">
                            </small>
                        </div>
                ...
                <template v-if="form.ftpDocEmitidos == true">
                    <div class="row" style="background-color:gainsboro">
                        <div class="col-md-6 center-el-checkbox mt-4">
                            <div :class="{'has-danger': errors.ftpEmitidosServer}"
                                class="form-group">
                                <label class="control-label">
                                    Servidor
                                </label>
                                <el-input
                                    v-model="form.ftpEmitidosServer"
                                    dusk="name">
                                </el-input>
                                <br>
                                <small
                                    v-if="errors.ftpEmitidosServer"
                                    class="form-control-feedback"
                                    v-text="errors.ftpEmitidosServer[0]">
                                </small>
                            </div>
                        </div>
                        <div class="col-md-6 center-el-checkbox mt-4">
                            <div :class="{'has-danger': errors.ftpEmitidosPort}"
                                class="form-group">
                                <label class="control-label">
                                    Puerto
                                </label>
                                <el-input
                                    v-model="form.ftpEmitidosPort"
                                    dusk="name">
                                </el-input>
                                <br>
                                <small
                                    v-if="errors.ftpEmitidosPort"
                                    class="form-control-feedback"
                                    v-text="errors.ftpEmitidosPort[0]">
                                </small>
                            </div>
                        </div>
                        <div class="col-md-6 center-el-checkbox mt-4">
                            <div :class="{'has-danger': errors.ftpEmitidosUser}"
                                class="form-group">
                                <label class="control-label">
                                    Usuario
                                </label>
                                <el-input
                                    v-model="form.ftpEmitidosUser"
                                    dusk="name">
                                </el-input>
                                <br>
                                <small
                                    v-if="errors.ftpEmitidosUser"
                                    class="form-control-feedback"
                                    v-text="errors.ftpEmitidosUser[0]">
                                </small>
                            </div>
                        </div>
                        <div class="col-md-6 center-el-checkbox mt-4">
                            <div :class="{'has-danger': errors.ftpEmitidosPass}"
                                class="form-group">
                                <label class="control-label">
                                    Contraseña
                                </label>
                                <el-input
                                    v-model="form.ftpEmitidosPass"
                                    dusk="name">
                                </el-input>
                                <br>
                                <small
                                    v-if="errors.ftpEmitidosPass"
                                    class="form-control-feedback"
                                    v-text="errors.ftpEmitidosPass[0]">
                                </small>
                            </div>
                        </div>
                        <div class="col-md-6 center-el-checkbox mt-4">
                            <div :class="{'has-danger': errors.ftpEmitidosRutaFac}"
                                class="form-group">
                                <label class="control-label">
                                    Ruta Facturas
                                </label>
                                <el-input
                                    v-model="form.ftpEmitidosRutaFac"
                                    dusk="name">
                                </el-input>
                                <br>
                                <small
                                    v-if="errors.ftpEmitidosRutaFac"
                                    class="form-control-feedback"
                                    v-text="errors.ftpEmitidosRutaFac[0]">
                                </small>
                            </div>
                        </div>
                        <div class="col-md-6 center-el-checkbox mt-4">
                            <div :class="{'has-danger': errors.ftpEmitidosRutaNota}"
                                class="form-group">
                                <label class="control-label">
                                    Ruta Notas
                                </label>
                                <el-input
                                    v-model="form.ftpEmitidosRutaNota"
                                    dusk="name">
                                </el-input>
                                <br>
                                <small
                                    v-if="errors.ftpEmitidosRutaNota"
                                    class="form-control-feedback"
                                    v-text="errors.ftpEmitidosRutaNota[0]">
                                </small>
                            </div>
                        </div>
                        <div class="col-md-6 center-el-checkbox mt-4">
                            <div :class="{'has-danger': errors.ftpEmitidosRutaRetencion}"
                                class="form-group">
                                <label class="control-label">
                                    Ruta Retenciones
                                </label>
                                <el-input
                                    v-model="form.ftpEmitidosRutaRetencion"
                                    dusk="name" >
                                </el-input>
                                <br>
                                <small
                                    v-if="errors.ftpEmitidosRutaRetencion"
                                    class="form-control-feedback"
                                    v-text="errors.ftpEmitidosRutaRetencion[0]">
                                </small>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <el-radio-group v-model="business" @change="changeModules">
                                    <el-radio :label="5" cheked >Facturador</el-radio>
                                </el-radio-group>
                            </div>
                        </div>
                        <div class="row">
...
export default {
    ...
    data() {
        return {
            ...
            titleDialog: '', // Ensure reactivity for titleDialog
            button_text: null,
            resource: 'clients',
            error: {},
            errors: {},
            ...
            apps: [],
            types: [],
            soap_sends: [{value: '01', text: 'Sunat'}, {value: '02', text: 'Ose'},{value: '03', text: 'Sri'}],
    ...
    async created() {
        await this.$http.get(`/${this.resource}/tables`)
            .then(response => {
                ...
                this.group_facturador = response.data.group_facturador
    ...
    methods: {
        ...
        changeModules() {
            ...
            if(this.business == 5){
                group.modules = this.getIds(this.group_facturador);
            }
