    ...
    methods: {
        ...
        async getRecord() {
            ...
            await this.$http.get(`/${this.resource}/record/${this.recordId}`).then(response => {
                ...
                this.form.customer_email = response.data.data.customer_email.split("|")[0];
                //console.log("Emails: ", this.form.customer_email);
        ...
        clickPrint(format) {
            window.open(`/print/cabeceraDocumentoElectronica/${this.form.external_id}/${format}`, '_blank');
        },
        clickDownloadImage() {
